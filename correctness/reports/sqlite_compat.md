...
Source: `correctness/cases/sqlite_compat.jsonl`

This report runs Python SQLGlot's SQLite-targeted output against stock `sqlite3`. A `sqlite-error` row is not a sqlgrok parity failure by itself; it is a SQLite compatibility or upstream SQLGlot candidate to investigate.
...
### `sqlite-compat-mysql-insert-ignore-sqlite-exec` (sqlite-error)
...
### `sqlite-compat-postgres-limit-all-sqlite-exec` (sqlite-error)
...
### `sqlite-compat-postgres-offset-only-sqlite-exec` (sqlite-error)
...
### `sqlite-compat-postgres-similar-to-sqlite-exec` (sqlite-error)
...
### `sqlite-compat-postgres-lateral-sqlite-exec` (sqlite-error)
...
### `sqlite-compat-mysql-lpad-sqlite-exec` (sqlite-error)
...
### `sqlite-compat-mysql-rpad-sqlite-exec` (sqlite-error)
...
### `sqlite-compat-mysql-substring-index-sqlite-exec` (sqlite-error)
