...
| --- | --- | --- | ---: |
| `match` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 1109 |
...
| `match` | `tests/dialects/test_clickhouse.py` | `test_clickhouse` | 194 |
