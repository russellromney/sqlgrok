...
| `mismatch` | `validate_identity` | 508 |
| `mismatch` | `validate_all` | 469 |
...
| --- | --- | --- | ---: |
| `match` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 1111 |
| `match` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 695 |
