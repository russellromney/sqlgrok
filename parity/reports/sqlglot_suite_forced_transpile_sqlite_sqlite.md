...
| `match` | `tests/dialects/test_duckdb.py` | `test_duckdb` | 467 |
...
| `match` | `tests/dialects/test_presto.py` | `test_presto` | 150 |
...
| `mismatch` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 81 |
