...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 5218 |
| `mismatch` | `validate_all` | 3786 |
| `match` | `validate_identity` | 2431 |
| `mismatch` | `validate_identity` | 1289 |
...
| `mismatch` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 345 |
