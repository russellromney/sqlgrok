...
| `mismatch` | `tests/dialects/test_duckdb.py` | `test_duckdb` | 146 |
| `mismatch` | `tests/dialects/test_clickhouse.py` | `test_clickhouse` | 144 |
...
| `match` | `tests/dialects/test_clickhouse.py` | `test_clickhouse` | 82 |
