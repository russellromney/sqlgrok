...
| --- | --- | --- | ---: |
| `match` | `sqlite` | `sqlite` | 10257 |
| `mismatch` | `sqlite` | `sqlite` | 2628 |
...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 7361 |
| `match` | `validate_identity` | 2797 |
| `mismatch` | `validate_all` | 1640 |
| `oracle-error` | `validate_identity` | 993 |
| `mismatch` | `validate_identity` | 916 |
