...
| --- | --- | --- | ---: |
| `match` | `sqlite` | `sqlite` | 9662 |
| `mismatch` | `sqlite` | `sqlite` | 3180 |
...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 6880 |
| `match` | `validate_identity` | 2683 |
| `mismatch` | `validate_all` | 2112 |
| `mismatch` | `validate_identity` | 996 |
...
| `mismatch` | `SELECT CURRENT_VERSION()` | 12 |
