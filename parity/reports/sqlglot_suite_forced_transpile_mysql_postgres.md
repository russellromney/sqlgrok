...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 6042 |
| `mismatch` | `validate_all` | 2894 |
...
| `match` | `tests/dialects/test_dialect.py` | `test_time` | 269 |
| `mismatch` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 249 |
