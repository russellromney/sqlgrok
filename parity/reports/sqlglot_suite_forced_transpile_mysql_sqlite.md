...
| --- | --- | --- | ---: |
| `match` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 1054 |
...
| `mismatch` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 115 |
