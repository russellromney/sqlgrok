...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 8546 |
| `match` | `validate_identity` | 3085 |
| `oracle-error` | `validate_identity` | 1135 |
| `oracle-error` | `validate_all` | 595 |
| `mismatch` | `validate_identity` | 532 |
| `mismatch` | `validate_all` | 391 |
...
| `match` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 668 |
| `match` | `tests/dialects/test_duckdb.py` | `test_duckdb` | 478 |
| `match` | `tests/dialects/test_dialect.py` | `test_time` | 314 |
...
| `match` | `tests/dialects/test_clickhouse.py` | `test_clickhouse` | 196 |
| `match` | `tests/dialects/test_dialect.py` | `test_cast` | 176 |
| `match` | `tests/dialects/test_presto.py` | `test_presto` | 169 |
| `match` | `tests/dialects/test_hive.py` | `test_hive` | 159 |
...
| `match` | `tests/dialects/test_tsql.py` | `test_tsql` | 107 |
| `match` | `tests/dialects/test_mysql.py` | `test_mysql` | 104 |
