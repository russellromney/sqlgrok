...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 8497 |
| `match` | `validate_identity` | 3200 |
| `oracle-error` | `validate_identity` | 949 |
| `mismatch` | `validate_identity` | 567 |
| `mismatch` | `validate_all` | 536 |
...
| `match` | `tests/dialects/test_duckdb.py` | `test_duckdb` | 483 |
