...
| --- | --- | --- | ---: |
| `match` | `postgres` | `sqlite` | 11064 |
| `mismatch` | `postgres` | `sqlite` | 1902 |
...
| `mismatch` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 158 |
...
| `mismatch` | `tests/dialects/test_postgres.py` | `test_postgres` | 76 |
