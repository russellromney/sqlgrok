...
| --- | --- | --- | ---: |
| `match` | `postgres` | `sqlite` | 11451 |
| `mismatch` | `postgres` | `sqlite` | 1516 |
...
| `mismatch` | `tests/dialects/test_postgres.py` | `test_postgres` | 67 |
