...
| --- | --- | --- | ---: |
| `match` | `postgres` | `sqlite` | 8618 |
| `mismatch` | `postgres` | `sqlite` | 3526 |
| `oracle-error` | `postgres` | `sqlite` | 1457 |
| `rust-error` | `postgres` | `sqlite` | 1426 |
...
| `rust-error` | `parser: Expected identifier` | 76 |
