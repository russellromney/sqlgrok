...
| --- | --- | --- | ---: |
| `match` | `postgres` | `sqlite` | 10218 |
| `mismatch` | `postgres` | `sqlite` | 2694 |
...
| `match` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 578 |
...
| `mismatch` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 156 |
