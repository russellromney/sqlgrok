...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 4542 |
| `mismatch` | `validate_all` | 4491 |
| `match` | `validate_identity` | 2428 |
| `mismatch` | `validate_identity` | 1339 |
...
| --- | --- | --- | ---: |
| `mismatch` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 594 |
| `match` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 589 |
