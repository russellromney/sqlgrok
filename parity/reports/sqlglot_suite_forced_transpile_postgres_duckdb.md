...
| Status | Helper | Count |
| --- | --- | ---: |
| `mismatch` | `validate_all` | 4697 |
| `match` | `validate_all` | 4336 |
| `match` | `validate_identity` | 2383 |
| `mismatch` | `validate_identity` | 1384 |
...
| `mismatch` | `tests/dialects/test_postgres.py` | `test_postgres` | 199 |
