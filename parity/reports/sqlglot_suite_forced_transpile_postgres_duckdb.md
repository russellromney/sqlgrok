...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 4773 |
| `mismatch` | `validate_all` | 4260 |
| `match` | `validate_identity` | 2498 |
| `mismatch` | `validate_identity` | 1269 |
...
| `mismatch` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 358 |
