...
| --- | --- | --- | ---: |
| `match` | `mysql` | `sqlite` | 10090 |
| `mismatch` | `mysql` | `sqlite` | 2614 |
...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 7420 |
| `match` | `validate_identity` | 2570 |
| `mismatch` | `validate_all` | 1508 |
| `oracle-error` | `validate_identity` | 1135 |
| `mismatch` | `validate_identity` | 1036 |
