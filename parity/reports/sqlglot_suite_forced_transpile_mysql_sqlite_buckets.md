...
| --- | --- | --- | ---: |
| `match` | `mysql` | `sqlite` | 11151 |
| `oracle-error` | `mysql` | `sqlite` | 1739 |
| `mismatch` | `mysql` | `sqlite` | 1565 |
...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 8227 |
| `match` | `validate_identity` | 2817 |
...
| `match` | `tests/dialects/test_redshift.py` | `test_redshift` | 99 |
