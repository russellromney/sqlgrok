...
| --- | --- | --- | ---: |
| `match` | `mysql` | `sqlite` | 10168 |
| `mismatch` | `mysql` | `sqlite` | 2536 |
...
| Status | Helper | Count |
| --- | --- | ---: |
| `match` | `validate_all` | 7492 |
| `match` | `validate_identity` | 2576 |
| `mismatch` | `validate_all` | 1436 |
...
| `mismatch` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 185 |
