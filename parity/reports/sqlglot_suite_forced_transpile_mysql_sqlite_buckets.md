...
| `match` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 535 |
...
| `mismatch` | `tests/dialects/test_bigquery.py` | `test_bigquery` | 197 |
...
| `mismatch` | `tests/dialects/test_clickhouse.py` | `test_clickhouse` | 67 |
