...
| --- | --- | --- | ---: |
| `match` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 922 |
...
| `mismatch` | `tests/dialects/test_snowflake.py` | `test_snowflake` | 247 |
...
| `match` | `tests/dialects/test_redshift.py` | `test_redshift` | 88 |
